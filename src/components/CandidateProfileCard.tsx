 ...
 * Used inside the comparator's sticky column headers.
 */
export function CandidateProfileCard({ candidate }: { candidate: Candidate }) {
  const proceso = extractProceso(candidate.identificador);
  return (
    <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-[#004a8f] via-[#005baa] to-[#00b0d8] p-4 shadow-glass ring-1 ring-white/30">
      {/* Specular highlight */}
      ...
      <div className="relative mt-3 grid grid-cols-1 gap-1.5 text-xs text-white/90">
